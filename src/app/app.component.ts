...
export class AppComponent implements OnInit {
  //endpoint da api
   apiEndpoint: string ='http://localhost:8082/api/produtos';
  //variável
  produtos: any[] = [];
  ...
  //metodo executado sempre que o componente e aberto
  ngOnInit(): void {
  ...
  cadastrarProduto(): void {
    ...
    this.httpClient.post(this.apiEndpoint, this.formCadastro.value, { responseType: 'text' })
      .subscribe(
        (mensagem) => {
